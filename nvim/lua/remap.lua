...
vim.keymap.set("n", "<leader>oy", "<cmd>ObsidianToday<cr>")
vim.keymap.set("n", "<leader>op", "<cmd>ObsidianPrevDay<cr>")
vim.keymap.set("n", "<leader>on", "<cmd>ObsidianNextDay<cr>")
vim.keymap.set("n", "<leader>om", "<cmd>ObsidianTemplate<cr>")
